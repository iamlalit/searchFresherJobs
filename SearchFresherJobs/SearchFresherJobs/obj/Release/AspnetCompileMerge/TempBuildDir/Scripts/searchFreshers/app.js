    ...
    $scope.setRecentSearch = function (keywords, location) {
        ...
        if (string !== '') {
            ...
            if ($scope.searchString == null) {
                ...
                $scope.searchStringURL = $scope.searchStringURL + ' , ' + stringURL;
                $scope.searchString = $scope.searchString + ',' + string;
            }
            console.log($scope.searchStringURL)
